...
# Load VCF file
vcf_file <- "Angus.phased.vcf"  # Replace with your VCF file path
...
write.table(comb_haps2 , file = "Angus.formatted_haplotypes.txt", sep = " ", quote = FALSE, row.names = FALSE, col.names = FALSE)
