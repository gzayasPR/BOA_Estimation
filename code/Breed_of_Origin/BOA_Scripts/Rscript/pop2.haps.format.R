...
# Load VCF file
vcf_file <- "pop2.phased.vcf"  # Replace with your VCF file path
...
write.table(comb_haps2 , file = "pop2.formatted_haplotypes.txt", sep = " ", quote = FALSE, row.names = FALSE, col.names = FALSE)
